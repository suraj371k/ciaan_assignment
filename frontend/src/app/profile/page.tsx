...
const Profile = () => {
  const { getUserPosts, userPosts, loading, error, deletePost } =
    usePostStore();
            ...
            <div className="space-y-4">
              ...
              <div className="bg-gray-50 rounded-xl p-6 border-l-4 border-indigo-400">
                <p className="text-gray-700 leading-relaxed text-lg">
                  {user?.bio ||
                    "Welcome to my profile! I'm excited to share my thoughts and connect with the community. Stay tuned for interesting posts and insights."}
                </p>
              </div>
            </div>
          </CardContent>
            ...
            <Card className="border-2 border-dashed border-gray-300 rounded-2xl bg-white/50">
              <CardContent className="flex flex-col items-center justify-center py-16 px-8 text-center">
                ...
                <p className="text-gray-500 mb-6 max-w-md">
                  Start sharing your thoughts with the world. Create your first
                  post to get started!
                </p>
